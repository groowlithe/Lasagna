...
void Info::draw(void)
{
	...
	if ((type == TYPE_INFO && ttl > 0) || (type == TYPE_ERROR && ttl > 0 && res != 0))
	{
		...
		{
			color = RGBA8(0x98, 0x4B, 0x43, normalizedTransparency);
			bordercolor = RGBA8(0x18, 0x12, 0x1E, normalizedTransparency);
			bgcolor = RGBA8(0xEA, 0xC6, 0x7A, normalizedTransparency);
